...
from ..models.integration import PlaidTransaction, PlaidAccount
    ...
    async def create_link_token(self, user_id: str) -> str:
        ...
        try:
            request = LinkTokenCreateRequest(
                ...
                country_codes=[CountryCode('US'), CountryCode('CA')],  # Add more as needed
                language='en',
    ...
    async def convert_to_expenses(
        ...
        for transaction in transactions:
            ...
            try:
                ...
                logger.warning(f"Failed to convert Plaid transaction {transaction.id} to expense: {e}")
                continue
